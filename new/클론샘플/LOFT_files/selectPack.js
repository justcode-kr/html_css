...
;(function ($) {
    ...
    var objStart = {
        ...
        _eListCreate      : function (findThis) {
            ...
            if (bPropSelected === false) {
                propWrap.children("ul").find('li:first').addClass("selected");
            }
        ...
        _eAnimation       : function (findSelected, str, figureNumber) {
            if (str == "downHide") {
                findSelected.css({height: 0, "display": "block"}).animate({height: figureNumber}, 300);
                ...
                findSelected.css({height: 0, top: -figureTop, "display": "block"}).animate({height: figureNumber, top: -(figureTop + figureNumber - 1)}, 300);
            } else if (str == "upShow") {
                var figureTop = (findSelected.outerHeight() - findSelected.height()) + 1;
                findSelected.css({"display": "block"}).animate({height: 0, top: -figureTop}, 300, function () {
                    $(this).css({top: "", height: "", "display": "none"});
                });
            } else if (str == "upHide") {
                findSelected.css({"display": "block"}).animate({height: 0}, 300, function () {
                    $(this).css({top: "", height: "", "display": "none"});
                });
            }
        }
